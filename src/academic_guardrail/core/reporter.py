...
<body>
    <div class="container">
        ...
        <footer class="footer">
            <p>Generated by <a href="https://github.com/LyraFelix/Academic_Guardrail_Agent" target="_blank">Academic Guardrail Agent</a> · Powered by Zero-Shot NLI & Retraction Watch 50K Index</p>
        </footer>
    </div>
